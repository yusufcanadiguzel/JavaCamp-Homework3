...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Course Tests
		CourseManager courseManager = new CourseManager(new NhCourseDao(), new MailLogger());
		...
		// Category Tests
		CategoryManager categoryManager = new CategoryManager(new JdbcCategoryDao(), new SmsLogger());
		...
		// Instructor Test
		InstructorManager instructorManager = new InstructorManager(new NhInstructorDao(), new FileLogger());
